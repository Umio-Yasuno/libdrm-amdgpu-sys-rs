...
/// AmdgpuDeviceHandle is a wrapper that ensures the underlying file descriptor (fd)
/// remains open as long as the [`DeviceHandle`] exists, preventing fd leaks.
///
...
impl LibDrmAmdgpu {
    #[deprecated(since = "0.8.15", note = "use the [LibDrmAmdgpu::init_device_handle_with_fd] instead")]
...
impl DeviceHandle {
    ...
    #[cfg(not(feature = "dynamic_loading"))]
    #[deprecated(since = "0.8.15", note = "use the [DeviceHandle::init_with_fd] instead")]
